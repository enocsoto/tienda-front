...
export default function PrestamosPage() {
  ...
  const [fecha, setFecha] = useState(() => fechaLocalYMD());
  ...
  return (
    <div>
      ...
      <div className="mb-6 flex items-center gap-2 text-sm text-slate-500">
        <Link href="/admin/cash" className="text-sky-600 hover:text-sky-700 font-medium flex items-center gap-1">
