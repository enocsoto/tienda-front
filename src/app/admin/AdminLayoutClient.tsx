...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    icon: ShoppingCart,
    children: [
      { name: "Punto de Venta", href: "/admin/sales", icon: ShoppingCart },
      { name: "Historial", href: "/admin/sales/history", icon: History },
  ...
  },
  {
    ...
    icon: Wallet,
    children: [
      { name: "Balance Diario", href: "/admin/cash", icon: Wallet },
      { name: "Préstamos", href: "/admin/loans", icon: HandCoins },
      { name: "Utilidades", href: "/admin/cash/profit", icon: TrendingUp },
    ],
  },
