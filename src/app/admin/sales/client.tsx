    ...
    try {
      await fetchApi("/ventas", {
        ...
        body: JSON.stringify({
          ...
          fecha_vencimiento:
            tipoVenta === "credito" && fechaVencimiento ? fechaVencimiento : undefined,
              ...
              <div>
                ...
                <select
                  ...
                  onChange={(e) => {
                    ...
                    setTipoVenta(v);
                    if (v === "contado") setFechaVencimiento("");
                  }}
            ...
            <div className="space-y-2">
              <div>
                <label className="text-xs font-medium text-slate-500 mb-1 block">
                  Cliente {tipoVenta === "contado" ? "(opcional)" : ""}
                </label>
                <div className="relative">
              ...
              {tipoVenta === "credito" && (
                <div>
                  <label className="text-xs font-medium text-slate-500 mb-1 block">Vencimiento del crédito</label>
                  <div className="relative">
