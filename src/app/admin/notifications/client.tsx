...
export default function NotificacionesPage() {
  ...
  const handleAction = async (notif: Notificacion) => {
    ...
    const routes: Record<string, string> = {
      CREDITO_VENCIDO: "/admin/credits",
      STOCK_CRITICO: "/admin/inventory",
      PEDIDO_RECIBIDO: "/admin/sales/history",
      VENTA_ANULADA: "/admin/sales/history",
      MARKUP_CAMBIO: "/admin/settings",
    };
