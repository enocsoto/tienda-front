...
import { ArrowLeft, TrendingUp, TrendingDown, BarChart2, Search, Filter, CreditCard, Send } from "lucide-react";
...
export default function UtilidadPage() {
  ...
  return (
    <div className="w-full max-w-4xl">
      ...
      {loading && (
        <div className="grid grid-cols-1 min-[480px]:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-5 gap-4 sm:gap-5 animate-pulse">
      ...
      {!loading && utilidad && (
        <div className="grid grid-cols-1 min-[480px]:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-5 gap-4 sm:gap-5">
          <StatCard
          ...
          <StatCard
            ...
            value={formatCOP(utilidad.total_egresos_nequi_transferencia ?? 0)}
            icon={Send}
            variant="danger"
            subtitle="Egresos por Nequi o transferencia en el período"
          />
          <StatCard
            ...
            icon={TrendingDown}
            variant="danger"
            subtitle="Total gastos y pagos (incluye efectivo y préstamos)"
          />
          <StatCard
            title="Utilidad Neta"
